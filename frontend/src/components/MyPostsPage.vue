<template>
  <div class="min-h-screen bg-gray-50 py-8 px-4">
    <div class="max-w-4xl mx-auto">
      <div class="mb-8">
        <h1 class="text-3xl font-light text-gray-900 mb-6">My Posts</h1>
      ...
      <div v-else-if="!posts || posts.length === 0" class="bg-white rounded-lg shadow-sm p-12 text-center">
        <p class="text-gray-500 mb-2">You haven't created any posts yet.</p>
        <p class="text-sm text-gray-400">Start writing to see your posts here.</p>
      </div>
...
const { result, loading, error, refetch } = useQuery(MY_POSTS_QUERY, null, {
